...
class ContainerSetupAppx(ContainerSetupBase):
    ...
    def _update_identity(self):
        ...
        for identity in identities:
            identity.set('ProcessorArchitecture', platform.machine())
            identity.set('Version', self.custom_args.get('image_version'))
    ...
    def _update_desktop_visual(self):
        ...
        for titel in titles:
            titel.set('ShortName', self.custom_args.get('image_name'))
    ...
    def _update_application_metadata(self):
        ...
        for alias in aliases:
            alias.set('Alias', self.custom_args.get('image_name'))
